...
object MemossistPromptBuilder {
    ...
    fun getCurrentDateTimeContext(): String {
        ...
        return "CURRENT REFERENCE DATE & TIME: ${sdf.format(java.util.Date())}\n"
    }
    ...
    private fun buildTellingPrompt(knownIntent: String, candidateExperiences: List<MemoryItem>): String =
        ...
        "- STRICT FACT EXTRACTION RULE: Facts are STRICTLY ONLY meaningful personal details, background, preferences, events, or state explicitly stated by the user that they could realistically ask to remember or retrieve in the future.\n" +
    ...
    private fun buildMixedPrompt(knownIntent: String, candidateExperiences: List<MemoryItem>): String = buildString {
        ...
        append("- Do not add, infer, explain, or invent facts. Keep facts clear and complete.\n")
